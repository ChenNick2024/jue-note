        ...
        <View className="flex-col px-6 py-10 gap-3">
          ...
          </View>
          {
            active === 1 ? (
              ...
              <TouchableOpacity onPress={handleRegister} className="bg-primary-300 shadow-md shadow-zinc-300 rounded-lg w-full py-3 mt-5">
                <View className="flex flex-row items-center justify-center">
                  <Text className="text-lg font-rubik-medium text-white ml-2">注册</Text>
                </View>
              </TouchableOpacity>
            )
          }
